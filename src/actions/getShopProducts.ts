...
export async function getShopProducts () {
  ...
  const productDB: Product[] = [
    { id: 1, name: 'Paste Sauce', price: 24.99, category:'lunch', image: images[0] },
    { id: 2, name: 'Pesto Tagli', price: 34.99, category:'lunch', image: images[1]},
    ...
    { id: 10, name: 'Pizza', price: 34.49, category:'lunch', image:images[1]},
