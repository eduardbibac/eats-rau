...
<div className="login-form py-16">
    <div className="min-h-[600px] lg:min-h-auto flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
            ...
            <a href="#" className="flex items-center justify-center mt-4 lg:mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
            ...
            <div className="hidden lg:flex mt-4 items-center justify-between">
                ...
                <p className="text-xs text-center text-gray-500 uppercase">or with username and password</p>
                <span className="border-b w-1/6 lg:w-1/5"></span>
            </div>
