      ...
      <DialogContent className="mb-6 flex flex-col max-h-[95vh] overflow-y-scroll min-w-[400px] lg:min-w-[1000px] p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <Input onChange={(e) => setProduct(prevProduct => ({ ...prevProduct, ro_product_name: e.target.value }))} id="ro_name" type="text" placeholder="Nume Produs"
          ...
          <div>
            ...
            <Input onChange={(e) => setProduct(prevProduct => ({ ...prevProduct, en_product_name: e.target.value }))} id="en_name" type="text" placeholder="Nume Produs"
              className="min-h-[40px]" />
          </div>
        </div>

        <Label className="mt-3" htmlFor="price">Preț RON</Label>
        <Input className="min-h-[40px]" id="price" type="text" placeholder="Preț"
        ...
        <Input className="min-h-[40px]" id="categories" type="text" placeholder="Categorii" />

        <Label className="mt-3" htmlFor="picture">Poză</Label>
        <Input className="min-h-[40px]" id="picture" type="file"
        ...
        <div className="grid sm:flex">
          <div className=" flex flex-col self-center mt-4 w-full h-full bg-slate-50 p-12 rounded-xl">
            <div className="self-center w-[250px]">
              <ShopCard disabled={true} product={
                {
                  name: product.ro_product_name ? product.ro_product_name : defaultProduct.ro_product_name,
                  image: product.image_link ? product.image_link : defaultProduct.image_link,
          ...
          <div className=" flex flex-col self-center mt-4 w-full h-full bg-slate-50 p-12 rounded-xl">
            <div className="self-center w-[250px]">
              <ShopCard disabled={true} product={
                {
                  name: product.en_product_name ? product.en_product_name : defaultProduct.en_product_name,
                  image: product.image_link ? product.image_link : defaultProduct.image_link,
                  price: product.price ? product.price : defaultProduct.price,
