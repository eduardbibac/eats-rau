  ...
  return (
    <>
      ...
      <div className="mt-12 container max-w-[900px] flex flex-col gap-5">
        ...
        <div className="mb-4 mt-10 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">
          Recent Sessions
        </div>
        {sessions!.map((s, i) => (
          <Card key={i}>
            <CardHeader>{s.device}</CardHeader>
            <CardContent className="grid gap-8">
              <div className="flex items-center gap-4">
                ...
                <form
                  action={invalidateUserSession}
                  className="ml-auto font-medium"
                >
                  <button name="id" value={s.id} type="submit">
                    <Trash2></Trash2>
                  </button>
                </form>
              </div>
