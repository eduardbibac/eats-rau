...
<div className="login-form py-16">
    <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
            ...
            <p className="text-xl text-gray-600 text-center">To continue, sign in with your university provided Microsoft account</p>
            ...
            <div className="mt-4 flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-center text-gray-500 uppercase">or sign in with QR</a>
                <span className="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div className="mt-4">
