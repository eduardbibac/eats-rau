...
<div className="login-form py-16">
    <div className="min-h-[600px] lg:min-h-auto flex-col lg:flex-row flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
            ...
            <a href="#" className="flex items-center mt-96 lg:mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
            ...
            <div className="hidden lg:flex mt-4 items-end justify-between">
                ...
                <a href="#" className="text-xs text-gray-500">Are you a guest ? Request access</a>
                {/* <span className="border-b w-1/5 md:w-1/4"></span> */}
            </div>
        </div>
    </div>
