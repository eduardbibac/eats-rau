...
INSERT INTO Products(id, ro_product_name, en_product_name, price, image_link) VALUES 
  (1,  'Cartofi prăjiț', 'French fries', 8.99, 'https://images.unsplash.com/photo-1585109649139-366815a0d713'),
  ...
  (6,  'Burger de vită', 'Beef Burger', 22.99, 'https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?q=80&w=2915&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
  ...
  (10, 'Piure de cartofi', 'Mashed Potatoes', 9.99, 'https://images.unsplash.com/photo-1571328003963-9742129e3951'),
