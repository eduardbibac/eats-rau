export default function TPill() {
  return (
    <div className="hidden sm:flex p-0.5 space-x-0.5 items-center border border-gray-200 rounded-full dark:border-white/20">
      <a
        className="py-1 px-2 inline-flex items-center gap-x-3 text-white text-xs font-medium rounded-full bg-gray-800 hover:bg-gray-900 hover:text-white dark:bg-white dark:text-neutral-800"
        href="../index.html"
      >
        Open Source
      </a>
      <a
        className="py-1 px-2 inline-flex items-center gap-x-3 text-gray-800 text-xs font-medium rounded-full hover:text-gray-600 dark:text-white dark:hover:text-neutral-200"
        href="../pro/index.html"
      >
        Preline Pro
