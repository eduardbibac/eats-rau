...
export default function TCardGrid() {
  return (
    <>
      {/* <!-- Create By Joker Banny --> */}
      <body className="bg-white">
        {/* <!-- Header Navbar --> */}
        <nav className="fixed left-0 top-0 z-20 w-full border-b border-gray-200 bg-white px-6 py-2.5 sm:px-4">
          <div className="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
            ...
            <div className="mt-2 sm:mt-0 sm:flex md:order-2">
              ...
              <button
                type="button"
                className="rounde mr-3 hidden rounded-lg border border-blue-700 px-6 py-1.5 text-center text-sm font-medium text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 md:inline-block"
              >
                Login
              </button>
              <button
                type="button"
                className="rounde mr-3 hidden rounded-lg bg-blue-700 px-6 py-1.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 md:mr-0 md:inline-block"
              >
                Register
              </button>
              {/* <!-- Register Button --> */}
        ...
        {/* <!-- Footer --> */}
        <footer className="bg-gray-200 py-6 text-gray-900">
            ...
            <div className="grid justify-center lg:justify-between">
              ...
              <div className="flex justify-center space-x-4 pt-4 lg:col-end-13 lg:pt-0">
                <a
                  ...
                  href="#"
                  title="Email"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-500 text-gray-50 duration-150 hover:bg-blue-600"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
